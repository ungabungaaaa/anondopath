  ...
  return (
    <section className="section-padding py-16 bg-white">
      <div className="container mx-auto">
        <div className="bg-gradient-to-br from-anondopath-blue/10 to-anondopath-teal/10 rounded-2xl p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex-shrink-0">
              <Button size="lg" variant="primary" animate>
