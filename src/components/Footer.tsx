...
const footerColumns: FooterColumn[] = [
  {
    ...
    links: [
      ...
      { title: "Virtual Labs", href: "#labs" },
      { title: "Collaborative Tools", href: "#tools" },
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Educator Community", href: "#community" },
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center text-gray-600">
                ...
                <span>contact@anondopath.com</span>
              </div>
              ...
              <ul className="space-y-3">
                {column.links.map((link, linkIndex) => (
                  <li key={linkIndex}>
                    <a 
                      href={link.href} 
                      className="text-gray-600 hover:text-anondopath-blue transition-colors"
                    >
                      {link.title}
                    </a>
                  </li>
            ...
            <div className="flex space-x-4">
              {socialIcons.map((social, index) => (
                <a
                  key={index}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-gray-200 hover:bg-anondopath-blue hover:text-white text-gray-600 flex items-center justify-center transition-colors"
