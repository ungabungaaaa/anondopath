...
const Hero = () => {
  return <section className="relative min-h-[90vh] flex items-center pt-16 pb-12 bg-gradient-to-br from-white via-blue-50 to-white overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 mt-12 lg:mt-0 flex justify-center animate-fade-in" style={{
          animationDelay: '0.3s'
        }}>
            <div className="relative w-full max-w-lg">
              ...
              <div className="relative glass rounded-2xl p-2 overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 object-scale-down">
                <img src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?auto=format&fit=crop&w=600&q=80" alt="Student using Anondopath" className="rounded-xl w-full h-auto object-cover" />
